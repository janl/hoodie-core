...
function _chgrp(options, group, file) {
  ...
  return execSync(util.format("chgrp %s %s", group, file), options);
}
...
function _chmod(options, mode, file) {
  ...
  return execSync(util.format("chmod %s %s", mode, file), options);
}
...
function _chown(options, user, group, file) {
  ...
  return execSync(util.format("chown %s%s %s", user, group, file), options);
}
